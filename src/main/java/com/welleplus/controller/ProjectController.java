				...
				for (FirmInfo firmInfo : firmInfos) {
					...
					if(result.getData()!=null){
						...
						for (Company company : companys) {
							...
							cInfo.setId(id);
							cInfo.setpId(pId);
							cInfo.setIcon("css/zTreeStyle/img/diy/3.png");
							infos.add(cInfo);
...
//							pId = id;
							...
							if(result.getData()!=null){
								...
								for (Section section : sections) {
									...
									sInfo.setId(id);
									sInfo.setpId(sid);
									sInfo.setIcon("css/zTreeStyle/img/diy/5.png");
									infos.add(sInfo);
									id++;
									...
									if(result.getData()!=null){
										...
										for (Project project : projects) {
											...
											pInfo.setId(id);
											pInfo.setpId(prid);
											pInfo.setIcon("css/zTreeStyle/img/diy/7.png");
											infos.add(pInfo);
											id++;
										}
									}
...
//			}
			...
			tInfo.setpId(id-1);
			tInfo.setIcon("css/zTreeStyle/img/diy/3.png");
			infos.add(tInfo);
			id++;
...
//					result = sectionServer.getSectionAsMap(correlation.getGradeid(), company.getId());
					if(result.getData()!=null){
						...
						seInfo.setpId(sid);
						seInfo.setIcon("css/zTreeStyle/img/diy/5.png");
						infos.add(seInfo);
						id++;
